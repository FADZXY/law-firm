...
export default function Home() {
  ...
  const team = [
    ...
    { name: "المحامي  وسام سنبل",   role: "شريك أول",      spec: "متخصص في قضايا التطوير العقاري والمقاولات والنزاعات العمالية.",           img: IMGS.team2 },
    { name: "المحامي أصيل سنبل",   role: "شريك",          spec: "مستشارة معتمدة في الملكية الفكرية وامتثال الشركات والأسواق المالية.",     img: IMGS.team2 },
  ];
