...
export default function Home() {
  ...
  const team = [
    { name: "د. أمير خيرالله", role: "الشريك المؤسس", spec: "خبير في قانون الشركات والتحكيم التجاري الدولي، بخبرة تتجاوز 30 عاماً.", img: IMGS.team1 },
    { name: "المحامي  اسامه سمبل",   role: "شريك أول",      spec: "متخصص في قضايا التطوير العقاري والمقاولات والنزاعات العمالية.",           img: IMGS.team2 },
    { name: "المحامية أصيل سمبل",   role: "شريك",          spec: "مستشارة معتمدة في الملكية الفكرية وامتثال الشركات والأسواق المالية.",     img: IMGS.team3 },
  ];
